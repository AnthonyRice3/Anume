...
export default function Testimonials () {
    ...
    return (
        <section className="relative py-14 bg-white">
                            ...
                            testimonials.map((item, idx) => (
                                <li key={idx} className="bg-white rounded-xl border shadow-md">
                                    ...
                                    <figure>
                                        ...
                                        <div className="flex items-center gap-x-4 p-4 mt-6 bg-slate-50">
                                            <Image alt="logo" src={item.avatar} className="w-16 h-16 rounded-full border-2 border-slate-500" width={150} height={150} />
                                            <div>
                                                <span className="block text-gray-800 font-semibold">{item.name}</span>
                                                <span className="block text-slate-600 text-sm mt-0.5">{item.title}</span>
                                            </div>
                                        </div>
                                    </figure>
                                </li>
            ...
            <div className="absolute top-0 w-full h-[350px] testimonial-gradient-bg"></div>
        </section>
    )
}