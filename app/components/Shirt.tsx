            ...
            <div className="bg-slate-500 p-6 rounded-lg shadow-lg max-w-screen-xl mx-auto px-4 text-slate-800 font-bold gap-16 justify-between md:px-8 lg:flex">
                ...
                >
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <Link href="https://buy.stripe.com/28E14mbFt0Eh5SSboJ3Je04" className="mt-8 inline-block px-6 py-3 rounded-lg text-sm font-semibold text-white bg-slate-950 hover:bg-slate-500 active:bg-slate-700 transition duration-150">
                            Buy Now!
                        </Link>
                    </motion.div>
                </motion.div>
