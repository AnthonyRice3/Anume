        ...
        <section className="py-14 bg-linear-to-bl from-slate-950 via-slate-900 to-slate-950">
            <div className="max-w-screen-xl mx-auto px-4 text-slate-400 md:px-8">
                <div className="max-w-xl space-y-3">
                    <h3 className="text-slate-200 text-3xl font-semibold sm:text-4xl">
                    ...
                    <ul className="grid gap-y-8 gap-x-12 sm:grid-cols-2 lg:grid-cols-3">
                        {
                            features.map((item, idx) => (
                                <li key={idx} className="flex gap-x-4">
                                    <div className="flex-none w-12 h-12 bg-slate-600 text-white rounded-lg flex items-center justify-center">
                                        {item.icon}
                                    </div>
