            ...
            <div className="max-w-screen-xl mx-auto md:px-8">
                <div className="items-center gap-x-12 sm:px-4 md:px-0 lg:flex">
                    <div className="flex-1 sm:hidden lg:block">
                        <Image src="/destr.png" className="md:max-w-lg sm:rounded-lg p-4" alt="" width={450} height={200} />
                    </div>
                    <div className="max-w-xl px-4 space-y-3 mt-6 sm:px-0 md:mt-0 lg:max-w-2xl">
                        ...
                        <a href="javascript:void(0)" className="bg-slate-700 hover:bg-slate-900 p-2 text-white rounded-xl inline-flex gap-x-1 items-center hover:text-slate-500 duration-150 font-medium">
                            Learn more
