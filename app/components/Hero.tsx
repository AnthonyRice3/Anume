                    ...
                    <div className="relative z-10 max-w-screen-xl mx-auto px-4 py-28 md:px-8">
                        <div className="space-y-5 max-w-4xl mx-auto text-center">
                            ...
                            >
                                ...
                                /> */}
                                <Link href='/Purchase' className="flex items-center justify-center gap-x-2 py-2.5 px-4 mt-3 w-full text-sm text-white font-medium bg-slate-950 hover:bg-slate-400 active:bg-slate-600 duration-150 cursor-pointer rounded-lg sm:mt-0 sm:w-auto">
                                    Get started
