            ...
            <div className="bg-slate-500 p-6 rounded-lg shadow-lg max-w-screen-xl mx-auto px-4 text-slate-800 font-bold gap-16 justify-between md:px-8 lg:flex">
                ...
                >
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <Link href="https://buy.stripe.com/7sY7sKcJxcmZgxwakF3Je03" className="mt-8 inline-block px-6 py-3 rounded-lg text-sm font-semibold text-white bg-slate-950 hover:bg-slate-500 active:bg-slate-700 transition duration-150">
                            Buy Now!
                        </Link>
                    </motion.div>
                </motion.div>
                <motion.div
                    ...
                    viewport={{ once: true }}
                >
                    <Image width={350} height={150} src="/hat.png" className="w-full shadow-lg rounded-lg border" alt="tshirt" />
                </motion.div>
            </div>
        </section>
    )
